...
# Miracle Number 费用计算
    ...
    contexts['Number_Total']=f.qs.aggregate(Number_Total=Sum('Number_0')*35+Sum('Number_1')*100+Sum('Number_2')*200+Sum('Number_3')*500+Sum('Number_4')*2000+Sum('Number_5')*5000+Sum('Line_Number')*35)
# Miracle PBX 费用计算
...
#Miracle Phone 费用计算
    ...
    contexts['Total']=f.qs.aggregate(Total=Sum('APP_Number')*10+Sum('SIP_Number')*10+Sum('Log_Number')*30+Sum('CC_Number')*30+Sum('HPR_Number')*10)
    # contexts['result'] = a
